      ...
      <div className="relative z-10 w-full lg:w-5/12 h-full flex flex-col justify-center px-6 sm:px-10 lg:px-12 xl:px-16 py-6 bg-[#0c0a09] overflow-hidden">
        ...
        <div className="max-w-md w-full mx-auto relative z-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl bg-[#14110f] hover:bg-[#1d1915] border border-[#2b241c] hover:border-[#42382c] text-[#ede7dc] text-xs font-serif tracking-wider transition-all duration-200 shadow-sm cursor-pointer mb-3 group"
          >
          ...
          <div className="flex items-center gap-3 my-3">
            <div className="flex-1 h-[1px] bg-[#1f1a15]" />
            <span className="text-[10px] font-mono uppercase tracking-wider text-[#7a7163]">
              or with confidential seal
            </span>
            <div className="flex-1 h-[1px] bg-[#1f1a15]" />
          </div>
