  ...
  return (
    <div suppressHydrationWarning className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 font-sans text-zinc-100">
      ...
      >
        ...
        <p className="text-zinc-400 text-center mb-8">Sign in to your PostHeart account</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl py-3 pl-11 pr-11 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-colors"
          ...
          <button 
            type="submit"
            className="w-full bg-gradient-to-r from-pink-500 to-rose-400 text-text-primary rounded-xl py-3 font-medium hover:opacity-90 transition-opacity mt-4 shadow-lg shadow-pink-500/20"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="text-center text-zinc-500 mt-8 text-sm">
          ...
          <a href="/register" className="text-pink-400 hover:text-pink-300 transition-colors">
            Create one
          </a>
        </p>
      </motion.div>
