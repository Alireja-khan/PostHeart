...
export default function MemoryTimelinePage() {
  ...
  return (
    <div className="w-full min-h-full bg-[#f9f8f6] p-8 lg:p-12 overflow-y-auto no-scrollbar">
      ...
      {/* Editorial Header */}
      <div className="mb-16 max-w-4xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#e6e4df] pb-6">
        <div>
          <span className="text-[10px] tracking-widest text-[#707070] uppercase font-semibold">Chronological Path</span>
          <h1 className="font-serif text-4xl font-bold text-[#1a1a1a] mt-1">Our Shared Timeline</h1>
        ...
        <button 
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-[#e6e4df] bg-white hover:border-[#1a1a1a] text-xs font-serif text-[#1a1a1a] transition-all card-shadow font-bold"
        >
      ...
      <div className="max-w-4xl mx-auto relative pb-24">
        ...
        <div className="space-y-12 relative z-10">
          {milestones.length === 0 ? (
            <div className="py-24 text-center bg-white border border-[#e6e4df] rounded-lg p-8 card-shadow">
              <span className="font-serif italic text-base text-[#707070]">No milestones added yet. Click "Add Milestone" to start our timeline.</span>
            </div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 -translate-x-1/2 flex items-center justify-center mt-6">
                    <div className="w-8 h-8 rounded-full border border-[#e6e4df] bg-[#f9f8f6] flex items-center justify-center shadow-xs">
                  ...
                  <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-8">
                    <motion.div
                      ...
                      className="bg-white border border-[#e6e4df] rounded-lg p-6 cursor-pointer card-shadow card-hover-shadow group flex flex-col"
                    >
                      {/* Category & Date */}
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <span className={`text-[9px] px-2 py-0.5 rounded font-serif uppercase tracking-wider ${
                          milestone.category === 'trip' 
                            ...
                            : 'bg-stone-50 text-[#707070] border border-[#e6e4df]'
                        }`}>
                          {milestone.category}
                        </span>
                      </div>
                      ...
                      {/* Image */}
                      <div className="w-full aspect-[16/10] rounded-md overflow-hidden mb-4 bg-stone-50 border border-[#e6e4df]/60 relative">
                        <img 
                          src={milestone.image} 
                          alt={milestone.title} 
                      ...
                      {/* Title */}
                      <h3 className="font-serif text-xl font-bold text-[#1a1a1a] group-hover:text-[#c2410c] transition-colors mb-1">
                        {milestone.title}
                      </h3>

                      {/* Location */}
                      <div className="flex items-center space-x-1 text-[#707070] mb-3">
                        <MapPin size={12} className="opacity-75" />
                        <span className="text-xs font-serif italic">{milestone.location}</span>
                      </div>

                      {/* Snippet */}
                      <p className="text-xs text-[#707070]/90 leading-relaxed font-sans line-clamp-2">
                        {milestone.description}
                      </p>

                      <div className="mt-4 pt-3 border-t border-[#e6e4df]/60 flex justify-between items-center text-[10px] uppercase tracking-widest font-semibold">
        ...
        {isAddModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-lg w-full max-w-lg shadow-2xl relative overflow-hidden flex flex-col p-6 border border-[#e6e4df]"
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-serif text-[#1a1a1a] text-xl font-bold">Add Memory Milestone</h3>
              </div>

              <form onSubmit={handleAddMilestone} className="space-y-4">
                <div>
                  <label className="block font-serif text-xs text-[#707070] font-semibold uppercase tracking-wider mb-1.5">Milestone Title</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block font-serif text-xs text-[#707070] font-semibold uppercase tracking-wider mb-1.5">Category</label>
                    <select
                      value={category}
                ...
                <div>
                  <label className="block font-serif text-xs text-[#707070] font-semibold uppercase tracking-wider mb-1.5">Location</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block font-serif text-xs text-[#707070] font-semibold uppercase tracking-wider mb-1.5">Description</label>
                  <textarea
        ...
        {selectedMilestone && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-lg w-full max-w-2xl shadow-2xl relative overflow-hidden flex flex-col border border-[#e6e4df]"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedMilestone(null)}
                className="absolute top-4 right-4 text-white md:text-[#707070] hover:text-[#1a1a1a] p-1.5 rounded-full hover:bg-stone-50/20 md:hover:bg-stone-50 transition-colors z-20"
              >
                <X size={18} />
              </button>

              {/* Photo Area */}
              <div className="w-full aspect-[16/9] bg-stone-100 overflow-hidden relative border-b border-[#e6e4df]">
                <img
              ...
              <div className="p-8 lg:p-10">
                <div className="flex justify-between items-baseline border-b border-[#e6e4df] pb-4 mb-5">
                  <h2 className="font-serif text-2xl font-bold text-[#1a1a1a]">
                    {selectedMilestone.title}
                  </h2>
                  <span className="font-serif text-xs tracking-wider text-[#707070] uppercase font-semibold">
                    {selectedMilestone.date}
                  </span>
                </div>

                <p className="font-serif text-base text-[#1a1a1a] leading-relaxed select-text selection:bg-[#c2410c]/10">
                  {selectedMilestone.description}
                </p>

                <div className="mt-8 pt-4 border-t border-[#e6e4df]/60 flex justify-between items-center text-[#707070] text-[10px] uppercase tracking-widest font-semibold">
